if(window.location.host != "javascript.withcodeexample.com" && window.location.host != "localhost:1313") {
  window.location = window.location.href.replace(window.location.host, "javascript.withcodeexample.com");
}
var main = {
  bigImgEl : null,
  numImgs : null,
